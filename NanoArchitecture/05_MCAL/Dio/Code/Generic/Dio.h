...
typedef struct
{
	...
	/** \brief Pointer to GPIO port. */
	volatile uint8 * pt_Registers;
...
extern const Dio_PortCfgType Dio_gkat_PortAdressWrite[DIO_NUMBER_OF_PORTS];
extern const Dio_PortCfgType Dio_gkat_PortAdressRead[DIO_NUMBER_OF_PORTS];
/*-------------------------------------------------------------------------------------------------------------------*/
